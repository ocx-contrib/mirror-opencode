...
OCX mirror for [opencode](https://github.com/anomalyco/opencode). Publishes
GitHub releases to `ocx.sh/opencode` with cascade tags after a smoke test per
`(version, platform)`.
...
Apache-2.0 — see [`LICENSE`](LICENSE). Upstream assets (opencode logo, mirrored
